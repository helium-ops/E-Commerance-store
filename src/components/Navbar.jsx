    ...
    return(
        <nav className="h-[6vh] w-full flex justify-between items-center bg-zinc-50 px-[2.5%]">
            ...
            <div className="flex justify-between items-center w-[13%] h-[80%]">
                <button className="h-[80%] w-[49%] bg-black text-white font-semibold rounded-[0.5vh] transition duration-[0.1s] text-[1.1vw] hover:opacity-[0.8]">Log in</button>
                <button className="h-[80%] w-[49%] text-white font-semibold rounded-[0.5vh] bg-blue-500 transition duration-[0.1s] text-[1.1vw] hover:opacity-[0.9]">Sign up</button>
            </div>
